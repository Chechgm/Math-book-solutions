...
Kreyszig 4.3 Hahn-Banach Theorem for Complex Vector Spaces and Normed Spaces
1
2 Some easy properties of seminorms
3 So if you are a real functional with f(ix) = if(x), then you are actually a complex functional
