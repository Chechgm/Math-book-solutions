...
There exists a sequence $(x_n, Tx_n)$ that converges to such point, and furthermore if $(x, z) = (x, z')$, where $y \neq y'$, were both in $\overline{G(T)}$, we would have that $(0, y) \in \overline{G(T)}$, with $y \neq 0$, which contradicts our assumption.
